...
## Not using Fedora anymore in the script because I have a current tester for that OS.
...
ansible-playbook playbook.yml --private-key  /home/dpro/.ssh/lnsf-ed25519 -i inventory -u root
